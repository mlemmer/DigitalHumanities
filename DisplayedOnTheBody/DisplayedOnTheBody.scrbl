...
@(define bib-Beasley
(make-bib
 #:title     "Beazley Pottery Database"
 #:date      "2018"
 #:location  (techrpt-location #:institution "Classical Art Research Centre"
                               #:number "")
 #:url       "http://www.beazley.ox.ac.uk"))

@(define bib-Blundell1995
(make-bib
 #:title     "Women In Ancient Greece."
 #:author    (authors "Sue Blundell")
 #:is-book?  "yes"
 #:date      "1995"
 #:location (book-location #:publisher "Cambridge, MA: Harvard University Press")))

@(define bib-Boardman2001
(make-bib
 #:title     "The History of Greek Vases: potters, painters, and pictures."
 #:author    (authors "John Boardman")
 #:is-book?  "yes"
 #:date      "2001"
 #:location (book-location #:publisher "New York: Thames & Hudson")))
...
@(define bib-Cahill2002
(make-bib
 #:title    "Household and City Organization at Olynthus."
 #:author   (authors "Nicholas Cahill")
 #:is-book? "yes"
 #:date     "2002"
 #:location (book-location #:publisher "New Haven: Yale University Press")))

@(define bib-Fischer2013
(make-bib
 #:title     "Ancient Greek Prostitutes and the Textile Industry in Attic Vase-Painting."
 #:author    (authors "Marina Fischer")
 #:date      "2013"
 #:location (journal-location "Classical World" #:pages '(219 259) #:number "2" #:volume "106")))
...
@(define bib-Heinrich2006
(make-bib
 #:title     "Das Epinetron: Aspekte der weiblichen Lebenswelt im Spiegel eines Arbeitsgeräts"
 #:author    (authors "Frauke Heinrich")
 #:is-book?  "yes"
 #:date      "2006"
 #:location (book-location #:publisher "Rahden: Verlag Marie Leidorf")))

@(define bib-Kanowski1984
(make-bib
 #:title     "Containers of Classical Greece: a handbook of shapes"
 #:author    (authors "M.G. Kanowski")
 #:is-book?  "yes"
 #:date      "1984"
 #:location (book-location #:publisher "St. Lucia, Queensland: University of Queensland Press")))
...
(make-bib
 ...
 #:is-book?  "yes"
 #:date      "1993"
 #:location (book-location #:publisher "Berkeley: University of California Press")))
...
@(define bib-Mercati2003
(make-bib
 #:title     "Epinetron: storia di una forma ceramica fra archeologia e cultura."
 #:author    (authors "Chiara Mercati")
 #:is-book?  "yes"
 #:date      "2003"
 #:location  (book-location #:publisher "Città di Castello: Petruzzi")))

@(define bib-MooreEtAl1986
(make-bib
 #:title     "Attic Black-Figured Pottery."
 #:author    (authors "Mary B. Moore" "Mary Zelia Pease Philippides" "Dietrich Von Bothmer")
 #:is-book?  "yes"
 #:date      "1986"
 #:location  (book-location #:publisher "Princeton, N.J.: American School of Classical Studies at Athens")))
...
@(define bib-Robinson1950
(make-bib
 #:title     "Excavations at Olynthus"
 #:author    (authors "David M. Robinson")
 #:is-book?  "yes"
 #:date      "1950"
 #:location  (book-location #:edition "13" #:publisher "Baltimore: Johns Hopkins")))

@(define bib-Smith2005
(make-bib
 #:title     "The Politics of Weddings at Athens: an Iconographic Assessment."
 #:author    (authors "Amy C. Smith")
 #:date      "2005"
 #:location  (journal-location "Leeds International Classical Studies" #:pages '(1 32) #:number "1" #:volume "4")))

@(define bib-StansburyODonnell2011
(make-bib
 #:title     "Looking at Greek Art."
 #:author    (authors "Mark Stansbury-O'Donnell")
 #:is-book?  "yes"
 #:date      "2011"
...
@figure["2" @elem{Attic Red Figure Epinetron from . Side A: Domestic scene, wool working, woman seated with epinetron, Side B: Domestic scene of women working with wool; Side C: Belerophon and the Chimaera. 450-400 BC, Athens, National Museum, CC1589, Beazley, 865. Image by As illustrated by Chiara Mercati, Copyright © 2003}]{@image["Fig2.jpg"]}

@figure["3" @elem{Attic Red Figure Epinetron from Euboea. Eretria. Side A: Domestic scene of women, some seated, Side B: Domestic scene of women, one seated, with a draped man with staff. Attributed to the Clio Painter. 475-424 BC, Athens, National Museum, 2383, Beazley, 214528.}]{@image["Fig3.jpg"]}

@figure["4" @elem{Attic Red Figure Epinetron Fragment from Agora, Athens. Woman with mirror, draped youth(?) with staff. Attributed to the Painter of Berlin. 550-500, Athens, Agora Museum, P7817, Beazley, 216682.}]{@image["Fig4.jpg"]}

@figure["5" @elem{Attic Red Figure Epinetron Fragment from Agora, Athens. Women, one seated on a chair with alabastron, and a figure (?) on a kline. 450-400 BC, Athens, Agora Museum, P18283, Beazley, 25250.}]{@image["Fig5.jpg"]}

@figure["6" @elem{Attic Black Figure Epinetron Fragment from Agora, Athens. Woman with a child and kalathos. 550-500 BC, Athens, Agora Museum, P16745, Beazley, 30828.}]{@image["Fig6.jpg"]}

@figure["7" @elem{East Greek Geometric Epinetron from Rhodes. Rhodes Archaeological Museum, Beazley, 9004842.}]{@image["Fig7.jpg"]}

@figure["8" @elem{East Greek Geometric Epinetron from Olynthus. This was found in a domestic context with loom weights and a spindle wohrl. Image as illustrated by David Robinson. Copyright © 1950.}]{@image["Fig8.jpg"]}

@figure["9" @elem{Toy/Model Epinetron from the tomb of a girl in Athens. Geometric decoration on body and molded female head on cap. 420 BC, London, British Museum, 1906,0314.4.}]{@image["Fig9.jpg"]}

@figure["10" @elem{Attic Black Figure Epinetron from . Side A: Domestic scene with women working wool, Side B: Amazons. Attributed to the Diosphos Painter. 550-500 BC, Musee du Louvre, MNC 624, Beazley, 303430. Image by Images downloaded via the Perseus Artifact DatabaseCopyright © Musee du Louvre}]{@image["Fig10.jpg"]}

@figure["11" @elem{Attic Black Figure Epinetron from . Side A: Domestic scene of women working wool; Side B: Maenads with thyrsoi. last quarter of the VI century BC, Athens, National Archaeological Museum, 2183. Image by As illustrated by Chiara MercatiCopyright © 2003.}]{@image["Fig11.jpg"]}

@figure["12" @elem{Attic Black Figure Epinetron from . Side A: Symposium with reclining men and seated women, Side B: Domestic scene of women working wool. Attributed to the Golonos Group. 550-500 BC, London, British Museum, B598, Beazley, 303420.}]{@image["Fig12.jpg"]}

@figure["13" @elem{Attic Black Figure Epinetron from Temple of Artemis at Amarynthos. Symposium Scene. Late sixth century BC, Archaeological Museume of Eretria.}]{@image["Fig13.jpg"]}

@figure["14" @elem{Attic Red Figure Epinetron from . Side A: Domestic scene with a woman seated on a stool and draped youths with staffs, Side B: Youths and woman. Attributed to the Painter of Berlin. 500-450 BC, Berlin, Antikensammlung, F2624, Beazley, 216679.}]{@image["Fig14.jpg"]}